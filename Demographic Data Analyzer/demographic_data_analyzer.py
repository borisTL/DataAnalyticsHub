...
def calculate_demographic_data(print_data=True):
    ...
    total_B = df[df['education'] == 'Bachelors'].shape[0]
    percentage_bachelors = round((total_B / total_count) * 100, 1)
    ...
    rich_people_by_country = rich_people['native-country'].value_counts()
    percentage_rich_by_country = (rich_people_by_country / total_people_by_country) * 100
    ...
    rich_people_in_india = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')]
    occupation_counts = rich_people_in_india['occupation'].value_counts()
